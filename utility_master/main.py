...
from utility_master.core.task_manager import TaskManager
from utility_master.core.ui import UI
from utility_master.core.base_plugin import Task, BasePlugin
...
class UtilityMaster:
    ...
    def __init__(self):
        self.ui = UI()
        # Use the correct path to the plugins directory
    ...
    def start_learning_session(self, plugin: BasePlugin) -> None:
        ...
        # Show introduction
        intro_text = plugin.get_introduction()
        if hasattr(self.ui, 'console'):
            self.ui.console.print(f"\n[bold cyan]{intro_text}[/bold cyan]")
        else:
            print(f"\n{intro_text}")
